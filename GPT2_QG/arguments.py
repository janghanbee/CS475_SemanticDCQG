...
parser.add_argument(
    "--train_dataset_path", type=str, default="/home/team5/QGStepByStep/GPT2_QG/dataset/hotpot_train_v1.1.json",
    help="Path of the train/dev split in the dataset. Default files are instances_train.pickle, instances_dev.pickle."
)
parser.add_argument(
    "--dev_dataset_path", type=str, default="/home/team5/QGStepByStep/GPT2_QG/dataset/hotpot_dev_fullwiki_v1.json",
    help="Path of the train/dev split in the dataset. Default files are instances_train.pickle, instances_dev.pickle."
)
parser.add_argument(
    "--filetype", type=str, default="baseline",
    help="Path of the train/dev split in the dataset. Default files are instances_train.pickle, instances_dev.pickle."
)
parser.add_argument(
    "--output_dir", type=str, default="./result",
